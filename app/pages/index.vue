        ...
        <UCard class="max-w-2xl mx-auto">
          ...
          <template #footer>
            <div class="flex justify-center space-x-4">
              <UButton to="/components" icon="i-lucide-layout-grid" size="lg">
                查看组件示例
              </UButton>
              <UButton
                to="/about"
...
// 颜色模式管理 - 使用 Nuxt UI 内置的 UColorModeButton 组件
// 无需手动管理颜色模式状态，UColorModeButton 会自动处理
